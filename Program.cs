...
namespace KK.Agent.Library
{
    public class Program
    {
        static async Task Main(string[] args)
        {
            ...
            // 6. Try with another question - e.g., about weather (if you have such a tool)
            Console.WriteLine("Question: What is the weather in Warsaw?");
            string response2 = await agent.RunAsync("What is the weather in Warsaw?");
